...
def inference_detector(model, img):
    ...
    with torch.no_grad():
        ...
        y_head_f_1, y_head_f_2, y_head_f_3, y_head_f_4, y_head_f_r_1, y_head_f_r_2, y_head_f_r_3, y_head_f_r_4, y_head_cls = model(return_loss=False, rescale=True, return_box=False, **data)
